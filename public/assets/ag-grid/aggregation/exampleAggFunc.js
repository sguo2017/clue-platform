var columnDefs = [
    ...
    {headerName: "年龄范围", field: "age", width: 90, cellRenderer: ageRenderer, aggFunc: minAndMaxAggFunction},
    // here we use an average func and specify the fucntion directly
    {headerName: "平均(年龄)", field: "age", width: 90, aggFunc: avgAggFunction},
    // here we use a custom sum function that was registered with the grid,
    // which overrides the built in sum function
    {headerName: "总(金牌)", field: "gold", width: 100, aggFunc: 'sum'},
    // and these two use the built in sum func
    {headerName: "abc(银牌)", field: "silver", width: 100, aggFunc: '123'},
    {headerName: "xyz(铜牌)", field: "bronze", width: 100, aggFunc: 'xyz'},
