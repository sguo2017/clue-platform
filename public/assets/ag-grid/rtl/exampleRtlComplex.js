...
var defaultCols = [
    {
        ...
        children: [
            firstColumn,
            {
                headerName: "语言", field: "language", width: 150, editable: true, filter: 'set',
            ...
            {
                headerName: "国籍", field: "country", width: 150, editable: true,
    ...
    },
    {
        ...
        headerName: '游戏属性',
        children: [
            {headerName: "游戏名称", field: "game.name", width: 180, editable: true, filter: 'set',
            ...
            {
                headerName: "是否购买", field: "game.bought", filter: 'set', editable: true, width: 100,
                // pinned: 'right',
                // rowGroupIndex: 2,
                // pivotIndex: 1,
                enableRowGroup: true,
    ...
    },
    {
        ...
        groupId: 'performance',
        children: [
            {headerName: "银行存款", field: "bankBalance", width: 150, editable: true,
            ...
            {
                headerName: "额外信息 1", columnGroupShow: 'open', width: 150, editable: false,
                suppressSorting: true, suppressMenu: true, cellStyle: {"text-align": "right"},
                cellRenderer: function() { return 'Abra...'; }
            },
            {
                headerName: "额外信息 2", columnGroupShow: 'open', width: 150, editable: false,
    ...
    {
        headerName: "评分", field: "rating", width: 100, editable: true, cellRenderer: ratingRenderer,
        floatCell: true,
        enableRowGroup: true,
        enablePivot: true,
        enableValue: true,
    ...
    {
        headerName: "总计得分", field: "totalWinnings", filter: 'number',
...
//get flags from here: http://www.freeflagicons.com/
    if (params.value === "" || params.value === undefined || params.value === null) {
        ...
        var flag = '<img border="0" width="15" height="10" src="../images/flags/' + COUNTRY_CODES[params.value] + '.png">';
