...
var columnDefs = [
    {headerName: "运动员", field: "athlete", width: 150, filter: PersonFilter, suppressMenu:true},
    {headerName: "年龄", field: "age", width: 90, filter: 'number', suppressMenu:true},
    {headerName: "国籍", field: "country", width: 120, filter: 'set', suppressMenu:true},
    {headerName: "年份", field: "year", width: 90, filter: 'number', suppressMenu:true},
    ...
    {headerName: "体育项目", field: "sport", width: 110, suppressMenu:true, filter:'text'},
    {headerName: "金牌", field: "gold", width: 100, filter: 'number', filterParams:{applyButton:true}, suppressMenu:true},
    {headerName: "银牌", field: "silver", width: 100, filter: 'number', floatingFilterComponentParams:{suppressFilterButton:true}},
    {headerName: "铜牌", field: "bronze", width: 100, filter: 'number', floatingFilterComponentParams:{suppressFilterButton:true}},
