...
var columnDefs = [
    {headerName: "运动员", field: "athlete", width: 150, filter: 'text', suppressFilter: true},
    {headerName: "金牌", field: "gold", width: 100, filter: 'number', filter: NumberFilter, suppressMenu: true},
    {headerName: "银牌", field: "silver", width: 100, filter: 'number', filter: NumberFilter, suppressMenu: true},
    {headerName: "铜牌", field: "bronze", width: 100, filter: 'number', filter: NumberFilter, suppressMenu: true},
    {headerName: "总计", field: "total", width: 100, filter: 'number', filter: NumberFilter, suppressMenu: true}
];
