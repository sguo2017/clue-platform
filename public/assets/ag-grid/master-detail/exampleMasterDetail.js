...
var masterColumnDefs = [
    ...
    {headerName: '通话次数', field: 'totalCalls'},
    {headerName: '累计时长', field: 'totalMinutes', cellFormatter: minuteCellFormatter}
];

var detailColumnDefs = [
    {headerName: '呼叫号码', field: 'callId', cellClass: 'call-record-cell'},
    {headerName: '呼叫类型', field: 'direction', cellClass: 'call-record-cell'},
    {headerName: '呼入号码', field: 'number', cellClass: 'call-record-cell'},
    {headerName: '通话时长', field: 'duration', cellClass: 'call-record-cell', cellFormatter: secondCellFormatter},
    {headerName: '交换机', field: 'switchCode', cellClass: 'call-record-cell'}
];
