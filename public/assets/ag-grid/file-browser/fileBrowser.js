(function() {
    ...
    var columnDefs = [
        {headerName: "文件名", field: "name", width: 250,
            cellRenderer: 'group',
            cellRendererParams: {
                innerRenderer: innerCellRenderer
            }
        },
        {headerName: "文件大小", field: "size", width: 70, cellStyle: sizeCellStyle},
        {headerName: "文件类型", field: "type", width: 150},
        {headerName: "修改日期", field: "dateModified", width: 150}
    ];
