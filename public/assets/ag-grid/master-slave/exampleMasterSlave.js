var columnDefs = [
    ...
    {headerName: "年龄", field: "age", width: 150},
    {headerName: "国籍", field: "country", width: 150},
    {headerName: "年份", field: "year", width: 120},
    {headerName: "日期", field: "date", width: 150},
    {headerName: "体育项目", field: "sport", width: 150},
    // in the total col, we have a value getter, which usually means we don't need to provide a field
    // however the master/slave depends on the column id (which is derived from the field if provided) in
    // order to match up the columns
    {headerName: '奖牌数',
        children: [
            {headerName: "总计", columnGroupShow: 'closed', field: "total",
                valueGetter: "data.gold + data.silver + data.bronze", width: 200},
            {headerName: "金牌", columnGroupShow: 'open', field: "gold", width: 100},
            {headerName: "银牌", columnGroupShow: 'open', field: "silver", width: 100},
            {headerName: "铜牌", columnGroupShow: 'open', field: "bronze", width: 100}
        ]
    }
];
