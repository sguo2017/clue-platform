var columnDefs = [
    {headerName: "运动员", field: "athlete", enableRowGroup: true},
    {headerName: "年龄", field: "age", enableRowGroup: true},
    {headerName: "国籍", field: "country", rowGroupIndex: 0, enableRowGroup: true},
    {headerName: "年份", field: "year", enableRowGroup: true},
    {headerName: "体育项目", field: "sport", enableRowGroup: true},
    {headerName: "金牌", field: "gold", aggFunc: 'sum'},
    {headerName: "银牌", field: "silver", aggFunc: 'sum'},
    {headerName: "铜牌", field: "bronze", aggFunc: 'sum'}
];
...
FakeServer.prototype.getData = function(request, callback) {
    ...
    var rowGroupCols = request && request.rowGroupCols || [];
    ...
    var valueCols = request && request.valueCols || [];
    ...
    var filterModel = request && request.filterModel;
    var sortModel = request && request.sortModel;
