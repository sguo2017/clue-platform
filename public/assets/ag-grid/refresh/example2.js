...
var columnDefs = [
    {headerName: "人员", field: 'name', width: 400, cellRenderer: 'group'},
    {field: 'nationality', rowGroupIndex: 0, hide: true},
    {
        headerName: '工作日数据',
        children: [
            {headerName: "周一",  field: "mon", cellRenderer: valueCellRenderer, cellClassRules: classRules, aggFunc: 'sum'},
            {headerName: "周二", field: "tue", cellRenderer: valueCellRenderer, cellClassRules: classRules, aggFunc: 'sum'},
            {headerName: "周三", field: "wed", cellRenderer: valueCellRenderer, cellClassRules: classRules, aggFunc: 'sum'},
            {headerName: "周四", field: "thur", cellRenderer: valueCellRenderer, cellClassRules: classRules, aggFunc: 'sum'},
            {headerName: "周五", field: "fri", cellRenderer: valueCellRenderer, cellClassRules: classRules, aggFunc: 'sum'}
        ]
    }
];
