...
function makeDoorSelectionAdornment() {
    ...
    return $(go.Adornment, "Vertical",
        ...
        $(go.Panel, "Horizontal", { defaultStretch: go.GraphObject.Vertical },
            $("Button",
                $(go.Picture, { source: "/assets/gojs/floorplanner/icons/flipDoorOpeningLeft.png", column: 0, desiredSize: new go.Size(12, 12) },
             ...
             $("Button",
                $(go.Picture, { source: "/assets/gojs/floorplanner/icons/flipDoorSide.png", column: 0, desiredSize: new go.Size(12, 12) }),
                {
                    click: function (e, obj) {
                        var floorplan = obj.part.diagram;
