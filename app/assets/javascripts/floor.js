...
function floor_init() {
	...
	// Floorplan
	myFloorplan = new Floorplan("tools_main_diagram");
	...
	// Overview
	myOverview = $(go.Overview, "tools_main_overview", { observed: myFloorplan, contentAlignment: go.Spot.Center, maxScale: 0.5 });
	...
	furniturePalette = new FloorplanPalette("tools_main_palette", myFloorplan, FURNITURE_NODE_DATA_ARRAY);
...
document.addEventListener("turbolinks:load", floor_init);
