...
$(document).on('turbolinks:load', function() {
  if ($('#tactic-progress-vue-app').length > 0) {
    initTacticProgressVue();
  }
});

function initTacticProgressVue() {
  const app = new Vue({
    el: '#tactic-progress-vue-app',
    mounted: function() {
      this.initHiddenFlowchart();
      this.initTacticProgressSwiper();
      this.initTacticTaskPieChart();
      this.initTacticProgressPopover();
    },
    data: {
      images: []
    },
    methods: {
      initTacticProgressPopover: function() {
      ...
      initTacticProgressSwiper: function() {
        // 初始化swiper
        const mySwiper = new Swiper('#swiper-container-tactics-progress', {
      ...
      initTacticTaskPieChart: function() {
        ...
        this.drawTaskPieChart('task-pie-chart-canvas', data, settings);
      },

      drawTaskPieChart: function(id, array, settings) {
